...
class MockKokoro:
    ...
    def create(self, text: str, voice: str = "af_heart", speed: float = 1.0, lang: str = "en-us") -> tuple[Any, int]:
        """Generate speech."""
...
class KokoroModelHandler:
    ...
    async def initialize(self) -> None:
        ...
        try:
            ...
            self._kokoro = Kokoro(str(self._model_file), str(self._voices_file))
