...
from tts_service.infrastructure.cache.protocols import (
    CacheStorageProtocol, CacheMetadataProtocol, EvictionPolicyProtocol
)
from tts_service.infrastructure.cache.cache_manager import CacheManager
from tts_service.infrastructure.exceptions import (
    CacheIOError, CachePermissionError, CacheDiskFullError, CacheSerializationError
)
...
async def test_cache_manager_get_stats(mock_components):
    ...
    # Setup test data
    metadata.metadata = {
        "key1": {"file_name": "file1.bin", "size": 100, "created_at": 1000, "last_accessed": 1000, "expires_at": 2000, "meta": {}},
        "key2": {"file_name": "file2.bin", "size": 200, "created_at": 1000, "last_accessed": 1000, "expires_at": 2000, "meta": {}},
    }
...
async def test_ensure_cache_size_eviction(mock_components):
    ...
    metadata.metadata["key1"] = {"file_name": "file1.bin", "size": 6000, "created_at": 1000, "last_accessed": 1000, "expires_at": 2000, "meta": {}}
    metadata.metadata["key2"] = {"file_name": "file2.bin", "size": 3000, "created_at": 1000, "last_accessed": 1000, "expires_at": 2000, "meta": {}}
