...
class TestTTSServiceProviderHandling:
    ...
    def available_provider(self):
        ...
        provider.get_voices = AsyncMock(return_value=[
        ...
        provider.get_languages = AsyncMock(return_value=[
            Language(code="en", name="English"),
            Language(code="es", name="Spanish"),
        ])
        provider.get_voice = AsyncMock(return_value=Voice(
            id="voice1", name="Voice 1", language="en", gender="female", provider="available"
        ))
        provider.generate_speech = AsyncMock(return_value=AudioResult(
    ...
    @pytest.mark.asyncio
    async def test_mixed_providers(self, mock_cache_manager, available_provider, unavailable_provider, failing_provider):
